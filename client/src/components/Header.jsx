...
export default function Header() {
    return (
        <div className="w-full max-w-none text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 bg-[#0a1b43]">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo text-white">Best hotel rental service on earth.</h1>
            <p className="max-w-2xl mx-auto font-Ovo text-white">Celebrating 10 years of customer satisfaction in multiple countries.</p>
