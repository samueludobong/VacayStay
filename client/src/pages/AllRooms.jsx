...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <button type="button" class="flex items-center gap-2.5 border border-gray-500/30 px-4 py-2 text-sm text-gray-800 rounded bg-white hover:text-[#1e3b96] hover:bg-[#1e3b96]/60 hover:border-[#1e3b96] active:scale-95 transition"
        ...
        Back
            ...
            <div>
                ...
                <h1 className='font-playfair text-4xl md:text-[40px]'>
                    {filteredRooms[0]?.hotel?.name} Hotel Rooms
                </h1>
